...
"""generate_spellcheck_config.py: Simple helper script for auto generating the spell check config
   ...
   keyboard subtype, and Android ignores the MetroboardBoard spell checker unless it declares the currently active system
   ...
   Before running this script, make sure that exactly one device is connected and that MetroboardBoard Debug (0.4.0-alpha1
...
PULL_CMD_INPUT = """run-as dev.patrickgold.metroboard.debug
...
<spell-checker xmlns:android="http://schemas.android.com/apk/res/android"
    android:label="@string/metroboard_app_name"
    android:settingsActivity="dev.patrickgold.metroboard.SettingsLauncherAlias">
"""
