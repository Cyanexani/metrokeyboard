...
fun Modifier.metroboardVerticalScroll(
    ...
    if (showScrollbar) {
        verticalScroll(scrollState).metroboardScrollbar(scrollState, scrollbarWidth, isVertical = true)
    } else {
        verticalScroll(scrollState)
    }
}

fun Modifier.metroboardHorizontalScroll(
    state: ScrollState? = null,
    showScrollbar: Boolean = true,
    ...
    val scrollState = state ?: rememberScrollState()
    if (showScrollbar) {
        horizontalScroll(scrollState).metroboardScrollbar(scrollState, scrollbarHeight, isVertical = false)
    } else {
        horizontalScroll(scrollState)
    }
}

fun Modifier.metroboardScrollbar(
    state: ScrollState,
