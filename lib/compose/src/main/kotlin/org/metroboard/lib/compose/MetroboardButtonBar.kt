...
@Composable
fun MetroboardButtonBar(content: @Composable MetroboardButtonBarScope.() -> Unit) {
    Surface(
        ...
        Column {
            ...
            Row(
                ...
                val scope = MetroboardButtonBarScope(this)
                content(scope)
            }
        }
    }
...
class MetroboardButtonBarScope(rowScope: RowScope) : RowScope by rowScope {
    @Composable
    fun ButtonBarButton(
        text: String,
