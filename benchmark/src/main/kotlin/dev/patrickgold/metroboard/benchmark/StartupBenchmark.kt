...
package dev.patrickgold.metroboard.benchmark
...
abstract class AbstractStartupBenchmark(private val startupMode: StartupMode) {
    ...
    private fun startup(compilationMode: CompilationMode) = benchmarkRule.measureRepeated(
        ...
        setupBlock = {
            pressHome()
            device.executeShellCommand("ime enable dev.patrickgold.metroboard/.MetroboardImeService")
            device.executeShellCommand("ime set dev.patrickgold.metroboard/.MetroboardImeService")
        }
    ) {
