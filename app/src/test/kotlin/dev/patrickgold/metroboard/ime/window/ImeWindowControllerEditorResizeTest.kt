...
import dev.patrickgold.metroboard.plusOrMinus
import dev.patrickgold.metroboard.shouldBeGreaterThanOrEqualTo
import dev.patrickgold.metroboard.shouldBeLessThanOrEqualTo
    ...
    context("for all root insets and fixed modes") {
        test("for all resizes on top handle") {
            checkAll(
                ...
                val prefs by jetprefDataStoreOf(MetroboardPreferenceModel::class)
