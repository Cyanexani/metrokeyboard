...
import org.metroboard.lib.kotlin.map

class MetroboardSpellCheckerService : SpellCheckerService() {
    ...
    override fun createSession(): Session {
        ...
        return MetroboardSpellCheckerSession()
    }
    ...
    private inner class MetroboardSpellCheckerSession : Session() {
        ...
        private fun setupSpellingIfNecessary() {
            val evaluatedSubtype = when (prefs.spelling.languageMode.get()) {
                SpellingLanguageMode.USE_KEYBOARD_SUBTYPES -> {
                    ...
                    Subtype.DEFAULT.copy(primaryLocale = MetroboardLocale.default())
                }
            }
