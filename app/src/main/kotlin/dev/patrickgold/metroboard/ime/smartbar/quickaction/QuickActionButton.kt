...
fun QuickActionButton(
    ...
    val elementName = when (type) {
        QuickActionBarType.INTERACTIVE_BUTTON -> MetroboardImeUi.SmartbarActionKey
        QuickActionBarType.INTERACTIVE_TILE -> MetroboardImeUi.SmartbarActionTile
        QuickActionBarType.EDITOR_TILE -> MetroboardImeUi.SmartbarActionsEditorTile
    }.elementName
    val attributes = mapOf(MetroboardImeUi.Attr.Code to action.keyData().code)
    val selector = when {
