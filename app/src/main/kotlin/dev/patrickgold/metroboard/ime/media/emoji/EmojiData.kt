...
import org.metroboard.lib.android.bufferedReader
...
data class EmojiData(
    ...
    companion object {
        ...
        suspend fun get(context: Context, locale: MetroboardLocale): EmojiData {
         ...
         */
        private fun resolveEmojiAssetPath(context: Context, locale: MetroboardLocale): String? {
