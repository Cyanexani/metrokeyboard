...
class MetroboardEditorInfo private constructor(val base: EditorInfo) {
    ...
    companion object {
        val Unspecified = MetroboardEditorInfo(EditorInfo())

        fun wrap(editorInfo: EditorInfo) = MetroboardEditorInfo(editorInfo)
    }
}
