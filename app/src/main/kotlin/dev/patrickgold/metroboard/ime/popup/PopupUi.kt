...
fun PopupBaseBox(
    ...
    SnyggBox(
        elementName = MetroboardImeUi.KeyPopupBox.elementName,
        ...
        if (shouldIndicateExtendedPopups) {
            SnyggIcon(
                elementName = MetroboardImeUi.KeyPopupExtendedIndicator.elementName,
                attributes = attributes,
...
fun PopupExtBox(
    ...
    SnyggColumn(MetroboardImeUi.KeyPopupBox.elementName, attributes, modifier = modifier) {
        for (row in elements.asReversed()) {
            SnyggRow(
                ...
                for (element in row) {
                    ...
                    val localAttrs = attributes.plus(MetroboardImeUi.Attr.Code to element.data.code)
                    SnyggBox(
                        elementName = MetroboardImeUi.KeyPopupElement.elementName,
