...
package dev.patrickgold.metroboard.ime.core

import dev.patrickgold.metroboard.ime.keyboard.LayoutType
import dev.patrickgold.metroboard.ime.keyboard.LayoutTypeId
import dev.patrickgold.metroboard.ime.keyboard.extCoreComposer
import dev.patrickgold.metroboard.ime.keyboard.extCoreCurrencySet
import dev.patrickgold.metroboard.ime.keyboard.extCoreLayout
import dev.patrickgold.metroboard.ime.keyboard.extCorePopupMapping
import dev.patrickgold.metroboard.ime.keyboard.extCorePunctuationRule
...
data class Subtype(
    val id: Long,
    val primaryLocale: MetroboardLocale,
    val secondaryLocales: List<MetroboardLocale>,
    ...
    companion object {
        ...
        val DEFAULT = Subtype(
            id = -1,
            primaryLocale = MetroboardLocale.from("en", "US"),
     ...
     */
    fun locales(): List<MetroboardLocale> {
