...
package dev.patrickgold.metroboard.ime.landscapeinput
...
class ExtractedInputRootView(val ims: MetroboardImeService, eet: ExtractEditText?) : FrameLayout(ims) {
        ...
        CompositionLocalProvider(
            ...
            ProvideLocalizedResources(
                ...
                MetroboardImeTheme {
                    ...
                    SnyggBox(MetroboardImeUi.ExtractedLandscapeInputLayout.elementName) {
                        SnyggRow(
                            modifier = Modifier
                                .fillMaxWidth()
                                .height(height),
                            ...
                            SnyggBox(
                                elementName = MetroboardImeUi.ExtractedLandscapeInputLayout.elementName,
                                modifier = Modifier
                                    .fillMaxHeight()
                                    .weight(1f),
                            ) {
                                val fieldStyle =
                                    rememberSnyggThemeQuery(MetroboardImeUi.ExtractedLandscapeInputField.elementName)
                            ...
                            SnyggButton(
                                MetroboardImeUi.ExtractedLandscapeInputAction.elementName,
                                onClick = {
