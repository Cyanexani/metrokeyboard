...
package dev.patrickgold.metroboard.ime.media
...
import dev.patrickgold.metroboard.ime.media.emoji.EmojiData
import dev.patrickgold.metroboard.ime.media.emoji.EmojiPaletteView
...
fun MediaInputLayout(
    ...
    SnyggColumn(
        elementName = MetroboardImeUi.Media.elementName,
        modifier = modifier
            .fillMaxWidth()
        ...
        SnyggRow(
            elementName = MetroboardImeUi.MediaBottomRow.elementName,
            modifier = Modifier
                .fillMaxWidth()
                .height(MetroboardImeSizing.keyboardRowBaseHeight * 0.8f),
        ) {
            KeyboardLikeButton(
                elementName = MetroboardImeUi.MediaBottomRowButton.elementName,
...
internal fun KeyboardLikeButton(
    ...
    keyData: KeyData,
    elementName: String = MetroboardImeUi.MediaEmojiKey.elementName,
    ...
    SnyggBox(
        ...
        attributes = mapOf(MetroboardImeUi.Attr.Code to keyData.code),
        selector = selector,
