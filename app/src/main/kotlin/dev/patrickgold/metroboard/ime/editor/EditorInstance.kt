...
package dev.patrickgold.metroboard.ime.editor
...
class EditorInstance(context: Context) : AbstractEditorInstance(context) {
    ...
    private fun currentInputConnection() = MetroboardImeService.currentInputConnection()

    override fun handleStartInputView(editorInfo: MetroboardEditorInfo, isRestart: Boolean) {
    ...
    override fun shouldDetermineComposingRegion(editorInfo: MetroboardEditorInfo): Boolean {
