...
import dev.patrickgold.metroboard.ime.smartbar.CachedInlineSuggestionsChipStyleSet
...
import dev.patrickgold.metroboard.lib.util.TimeUtils.javaLocalTime
    ...
    data class ThemeInfo(
        ...
        companion object {
            val DEFAULT = ThemeInfo(
                ...
                stylesheet = MetroboardImeThemeBaseStyle,
                loadedDir = null,
                loadFailure = null,
            )
        }
