...
package dev.patrickgold.metroboard.ime.nlp.han
...
import dev.patrickgold.metroboard.ime.nlp.LanguagePackComponent
import dev.patrickgold.metroboard.ime.nlp.LanguagePackExtension
import dev.patrickgold.metroboard.ime.nlp.SpellingProvider
import dev.patrickgold.metroboard.ime.nlp.SpellingResult
import dev.patrickgold.metroboard.ime.nlp.SuggestionCandidate
import dev.patrickgold.metroboard.ime.nlp.SuggestionProvider
...
class HanShapeBasedLanguageProvider(val context: Context) : SpellingProvider, SuggestionProvider {
    companion object {
        ...
        const val ProviderId = "org.metroboard.nlp.providers.han.shape"
