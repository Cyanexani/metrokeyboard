/*
 * Copyright (C) 2021-2026 The MetroboardBoard Contributors
 *
...
import org.metroboard.lib.snygg.ui.uriOrNull
...
fun ImeSystemUi() {
    ...
    val backgroundQuery = rememberSnyggThemeQuery(MetroboardImeUi.Window.elementName)
        ...
        Row(
            ...
            if (!showHideAndSwitch) {
                Box(
                    ...
                    MetroboardIconButton(
                        onClick = {
                            MetroboardImeService.switchToNextInputMethod()
                        },
                        onLongClick = {
                            MetroboardImeService.showImePicker()
                        }
                    ) {
...
private fun RowScope.NavigationPill() {
    ...
    val style = rememberSnyggThemeQuery(MetroboardImeUi.WindowMoveHandle.elementName, attributes)
    ...
    Box(
        ...
        Box(
            modifier = Modifier
                .size(size)
                .background(scrimColor, RectangleShape)
