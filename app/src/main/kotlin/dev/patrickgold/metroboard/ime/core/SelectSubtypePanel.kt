...
import org.metroboard.lib.snygg.ui.SnyggListItem
...
fun SelectSubtypePanel(modifier: Modifier = Modifier) {
    ...
    SnyggColumn(MetroboardImeUi.SubtypePanel.elementName, modifier = modifier.safeDrawingPadding()) {
        SnyggRow(
            elementName = MetroboardImeUi.SubtypePanelHeader.elementName,
        ...
        SnyggBox(MetroboardImeUi.SubtypePanelList.elementName) {
            LazyColumn(
                state = listState,
            ) {
                items(
                    ...
                    SnyggListItem(
                        elementName = MetroboardImeUi.SubtypePanelListItem.elementName,
                        onClick = {
