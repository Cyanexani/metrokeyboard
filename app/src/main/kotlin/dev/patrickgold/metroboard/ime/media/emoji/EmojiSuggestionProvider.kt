...
import dev.patrickgold.metroboard.ime.nlp.EmojiSuggestionCandidate
...
class EmojiSuggestionProvider(private val context: Context) : SuggestionProvider {
    override val providerId = "org.metroboard.nlp.providers.emoji"

    private val prefs by MetroboardPreferenceStore
    private val lettersRegex = "^[A-Za-z]*$".toRegex()

    private val cachedEmojiMappings = Cache.Builder<MetroboardLocale, EmojiDataBySkinTone>().build()
