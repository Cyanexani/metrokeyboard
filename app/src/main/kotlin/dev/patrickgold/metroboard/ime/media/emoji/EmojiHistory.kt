...
object EmojiHistoryHelper {
    ...
    suspend fun markEmojiUsed(prefs: MetroboardPreferenceModel, emoji: Emoji): Unit = emojiGuard.withLock {
    ...
    suspend fun pinEmoji(prefs: MetroboardPreferenceModel, emoji: Emoji): Unit = emojiGuard.withLock {
        if (!prefs.emoji.historyEnabled.get()) {
            return
        }
    ...
    suspend fun unpinEmoji(prefs: MetroboardPreferenceModel, emoji: Emoji): Unit = emojiGuard.withLock {
        if (!prefs.emoji.historyEnabled.get()) {
            return
        }
    ...
    suspend fun moveEmoji(prefs: MetroboardPreferenceModel, emoji: Emoji, offset: Int): Unit = emojiGuard.withLock {
    ...
    suspend fun removeEmoji(prefs: MetroboardPreferenceModel, emoji: Emoji): Unit = emojiGuard.withLock {
        if (!prefs.emoji.historyEnabled.get()) {
            return
        }
    ...
    suspend fun deleteHistory(prefs: MetroboardPreferenceModel): Unit = emojiGuard.withLock {
        if (!prefs.emoji.historyEnabled.get()) {
            return
        }
        val dataMut = prefs.emoji.historyData.get().edit()
    ...
    suspend fun deletePinned(prefs: MetroboardPreferenceModel): Unit = emojiGuard.withLock {
        if (!prefs.emoji.historyEnabled.get()) {
            return
        }
        val dataMut = prefs.emoji.historyData.get().edit()
