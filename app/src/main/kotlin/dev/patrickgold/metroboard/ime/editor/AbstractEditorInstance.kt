...
import dev.patrickgold.metroboard.ime.nlp.BreakIteratorGroup
...
import org.metroboard.lib.kotlin.guardedByLock
...
abstract class AbstractEditorInstance(context: Context) {
    ...
    private val _activeInfoFlow = MutableStateFlow(MetroboardEditorInfo.Unspecified)
    val activeInfoFlow = _activeInfoFlow.asStateFlow()
    inline var activeInfo: MetroboardEditorInfo
    ...
    open fun handleStartInput(editorInfo: MetroboardEditorInfo) {
    ...
    open fun handleStartInputView(editorInfo: MetroboardEditorInfo, isRestart: Boolean) {
        if (isRestart) {
    ...
    protected open fun reset() {
        activeInfo = MetroboardEditorInfo.Unspecified
        activeCursorCapsMode = InputAttributes.CapsMode.NONE
        activeContent = EditorContent.Unspecified
    ...
    private suspend fun generateContent(
        editorInfo: MetroboardEditorInfo,
    ...
    private suspend fun EditorContent.generateCopy(
        editorInfo: MetroboardEditorInfo = activeInfo,
    ...
    protected open fun shouldDetermineComposingRegion(editorInfo: MetroboardEditorInfo): Boolean {
