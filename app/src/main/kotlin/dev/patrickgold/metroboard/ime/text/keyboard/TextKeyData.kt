...
import dev.patrickgold.metroboard.lib.Unicode
...
class AutoTextKeyData(
    ...
    private inner class AutoLetterState {
        private var locale: MetroboardLocale = MetroboardLocale.ROOT
        var lower: TextKeyData = TextKeyData.UNSPECIFIED
            private set
        var upper: TextKeyData = TextKeyData.UNSPECIFIED
            private set

        fun recomputeIfNecessary(locale: MetroboardLocale) {
