...
import dev.patrickgold.metroboard.lib.compose.vectorResource
import org.metroboard.lib.compose.icons.ForwardDelete
...
interface ComputingEvaluator {
    ...
    val editorInfo: MetroboardEditorInfo
...
object DefaultComputingEvaluator : ComputingEvaluator {
    ...
    override val editorInfo = MetroboardEditorInfo.Unspecified
...
private var cachedDisplayNameState = Triple(MetroboardLocale.ROOT, DisplayLanguageNamesIn.SYSTEM_LOCALE, "")
 ...
 */
private fun computeLanguageDisplayName(locale: MetroboardLocale, displayLanguageNamesIn: DisplayLanguageNamesIn): String {
...
fun ComputingEvaluator.computeImageVector(data: KeyData): ImageVector? {
    ...
    return when (data.code) {
        ...
        KeyCode.TOGGLE_FLOATING_WINDOW -> {
            ...
            val windowController = MetroboardImeService.windowControllerOrNull() ?: return enabledIcon
