...
object AppVersionUtils {
    ...
    fun shouldShowChangelog(context: Context, prefs: MetroboardPreferenceModel): Boolean {
        val installVersion =
    ...
    suspend fun updateVersionOnInstallAndLastUse(context: Context, prefs: MetroboardPreferenceModel) {
    ...
    suspend fun updateVersionLastChangelog(context: Context, prefs: MetroboardPreferenceModel) {
