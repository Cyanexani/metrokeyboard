...
package dev.patrickgold.metroboard.lib.devtools
...
import dev.patrickgold.metroboard.lib.util.TimeUtils
import dev.patrickgold.metroboard.lib.util.UnitUtils
...
object Devtools {
    fun generateDebugLog(context: Context, prefs: MetroboardPreferenceModel? = null, includeLogcat: Boolean = false): String {
        return buildString {
    ...
    fun generateDebugLogHeader(context: Context, prefs: MetroboardPreferenceModel? = null): String {
        return buildString {
    ...
    fun generateDebugLogForGithub(context: Context, prefs: MetroboardPreferenceModel? = null, includeLogcat: Boolean = false): String {
        return buildString {
            appendLine("<details>")
    ...
    fun generateAppInfoLog(context: Context, withTitle: Boolean = true): String {
        return buildString {
            ...
            append("Name                : ").appendLine(context.resources.getString(R.string.metroboard_app_name))
    ...
    fun generateFeatureConfigLog(prefs: MetroboardPreferenceModel, withTitle: Boolean = true): String {
        return buildString {
