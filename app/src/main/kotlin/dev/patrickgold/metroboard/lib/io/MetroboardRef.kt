...
package dev.patrickgold.metroboard.lib.io
 ...
 * MetroboardBoard's app user interface screens, APK assets, cache and internal
 * storage, external resources provided to MetroboardBoard via content URIs, as
 * well as hyperlinks.
 *
 ...
 */
@Serializable(with = MetroboardRef.Serializer::class)
@JvmInline
value class MetroboardRef private constructor(val uri: Uri) {
    companion object {
        @VisibleForTesting(otherwise = VisibleForTesting.PRIVATE)
        internal const val SCHEME_METROBOARD = "metroboard"
        ...
        /**
         * Constructs a new [MetroboardRef] pointing to a UI screen within the app
         * user interface.
         *
        ...
        /**
         * Constructs a new [MetroboardRef] pointing to a resource within the
         * MetroboardBoard APK assets.
         *
        ...
        /**
         * Constructs a new [MetroboardRef] pointing to a resource within the
         * cache storage of MetroboardBoard.
         *
        ...
        /**
         * Constructs a new [MetroboardRef] pointing to a resource within the
         * internal storage of MetroboardBoard.
         *
         ...
         * destination, regardless of within MetroboardBoard or not.
         *
         * @param uri The destination, denoted by a system URI format.
         *
         * @return The newly constructed reference.
         */
        fun from(uri: Uri) = MetroboardRef(uri)
         ...
         * @return The newly constructed reference.
         */
        fun from(str: String): MetroboardRef {
            ...
            return when {
                ...
                else -> MetroboardRef(Uri.parse(str))
            }
        }
         ...
         * @return The newly constructed reference.
         */
        fun fromUrl(url: String): MetroboardRef {
            return MetroboardRef(when {
         ...
         * point to any destination, regardless of within MetroboardBoard or not.
         *
     ...
     */
    val isAppUi: Boolean
        get() = uri.scheme == SCHEME_METROBOARD && uri.authority == AUTHORITY_APP_UI

    /**
     * True if the scheme and authority indicates a reference to a MetroboardBoard APK asset
     * resource, false otherwise.
     */
    val isAssets: Boolean
        get() = uri.scheme == SCHEME_METROBOARD && uri.authority == AUTHORITY_ASSETS

    /**
     * True if the scheme indicates a reference to a MetroboardBoard cache
     * resource, false otherwise.
     */
    val isCache: Boolean
        get() = uri.scheme == SCHEME_METROBOARD && uri.authority == AUTHORITY_CACHE

    /**
     * True if the scheme indicates a reference to a MetroboardBoard internal
     * storage resource, false otherwise.
     */
    val isInternal: Boolean
        get() = uri.scheme == SCHEME_METROBOARD && uri.authority == AUTHORITY_INTERNAL
    ...
    val isExternal: Boolean
        get() = uri.scheme != SCHEME_METROBOARD
    ...
    /**
     * Returns if this URI contains data for all valid parts of a MetroboardRef.
     */
    val isValid: Boolean
     ...
     *
     * @param assets The lambda to run when the reference points to the MetroboardBoard
     *  screen UI resources. Defaults to do nothing.
     * @param assets The lambda to run when the reference points to the MetroboardBoard
     *  APK assets. Defaults to do nothing.
     * @param cache The lambda to run when the reference points to the MetroboardBoard
     *  cache resources. Defaults to do nothing.
     * @param internal The lambda to run when the reference points to the MetroboardBoard
     ...
     */
    fun whenSchemeIs(
        appUi: (ref: MetroboardRef) -> Unit = { /* Do nothing */ },
        assets: (ref: MetroboardRef) -> Unit = { /* Do nothing */ },
        cache: (ref: MetroboardRef) -> Unit = { /* Do nothing */ },
        internal: (ref: MetroboardRef) -> Unit = { /* Do nothing */ },
        external: (ref: MetroboardRef) -> Unit = { /* Do nothing */ }
    ) {
        contract {
    ...
    object Serializer : PreferenceSerializer<MetroboardRef>, KSerializer<MetroboardRef> {
        override val descriptor = PrimitiveSerialDescriptor("MetroboardRef", PrimitiveKind.STRING)

        override fun serialize(value: MetroboardRef): String {
            return value.toString()
        }

        override fun serialize(encoder: Encoder, value: MetroboardRef) {
            encoder.encodeString(value.toString())
        }

        override fun deserialize(value: String): MetroboardRef {
            return from(value)
        }

        override fun deserialize(decoder: Decoder): MetroboardRef {
