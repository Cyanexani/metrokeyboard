...
import dev.patrickgold.metroboard.lib.validate
...
object ExtensionValidation {
    ...
    val SnyggStaticColorValue = ValidationRule<String> {
        forKlass = org.metroboard.lib.snygg.value.SnyggStaticColorValue::class
        forProperty = "color"
        validator { input ->
            val str = input.trim()
            when {
                str.isBlank() -> resultInvalid(error = R.string.ext__validation__enter_color)
                org.metroboard.lib.snygg.value.SnyggStaticColorValue.deserialize(str).isFailure -> {
    ...
    val SnyggDpShapeValue = ValidationRule<String> {
        forKlass = org.metroboard.lib.snygg.value.SnyggDpShapeValue::class
        forProperty = "corner"
        validator { str ->
    ...
    val SnyggPercentShapeValue = ValidationRule<String> {
        forKlass = org.metroboard.lib.snygg.value.SnyggPercentShapeValue::class
        forProperty = "corner"
        validator { str ->
