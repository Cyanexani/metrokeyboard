...
@Composable
fun SelectLocaleScreen() = MetroboardScreen {
    ...
    val systemLocales =
        MetroboardLocale.extendedAvailableLocales(context).sortedBy { locale ->
        ...
        if (searchTermValue.text.isBlank()) {
            ...
            systemLocales.filter { locale ->
                locale.displayName().lowercase().contains(term) ||
                    ...
                    locale.displayName(MetroboardLocale.ENGLISH).lowercase().contains(term) ||
    ...
    content {
        ...
        Column(modifier = Modifier.fillMaxSize()) {
            ...
            LazyColumn(
                modifier = Modifier
                    .weight(1f)
                    .metroboardScrollbar(state, isVertical = true),
                state = state,
            ) {
