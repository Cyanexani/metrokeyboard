...
import dev.patrickgold.metroboard.ime.dictionary.MetroboardUserDictionaryDatabase
...
@Composable
fun DevtoolsScreen() = MetroboardScreen {
            ...
            MetroboardConfirmDeleteDialog(
                onConfirm = {
                    DictionaryManager.default().let {
                        ...
                        it.metroboardUserDictionaryDao()?.deleteAll()
                    }
                    setShowDialog(false)
                },
                onDismiss = { setShowDialog(false) },
                what = MetroboardUserDictionaryDatabase.DB_FILE_NAME,
            )
        }
    }
}
