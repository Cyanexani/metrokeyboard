...
import dev.patrickgold.metroboard.app.apptheme.MetroboardAppTheme
...
import dev.patrickgold.metroboard.lib.compose.LocalPreviewFieldController
...
import dev.patrickgold.metroboard.lib.util.AppVersionUtils
import dev.patrickgold.jetpref.datastore.model.collectAsState
import dev.patrickgold.jetpref.datastore.ui.ProvideDefaultDialogPrefStrings
import java.util.concurrent.atomic.AtomicBoolean
import org.metroboard.lib.android.AndroidVersion
import org.metroboard.lib.android.hideAppIcon
import org.metroboard.lib.android.showAppIcon
...
class MetroboardAppActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        prefs.other.settingsLanguage.asFlow().collectIn(lifecycleScope) {
            ...
            val locale = if (it == "auto") MetroboardLocale.default() else MetroboardLocale.fromTag(it)
        ...
        appContext.preferenceStoreLoaded.collectIn(lifecycleScope) { loaded ->
            ...
            setContent {
                ProvideLocalizedResources(
                    ...
                    MetroboardAppTheme(theme = appTheme) {
