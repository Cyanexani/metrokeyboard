...
import dev.patrickgold.metroboard.lib.UnicodeCtrlChar
import dev.patrickgold.jetpref.material.ui.ColorRepresentation
import org.metroboard.lib.kotlin.simpleNameOrEnclosing
import org.metroboard.lib.snygg.Snygg
import org.metroboard.lib.snygg.SnyggElementRule
import org.metroboard.lib.snygg.value.SnyggCircleShapeValue
...
import org.metroboard.lib.snygg.value.SnyggInheritValue
import org.metroboard.lib.snygg.value.SnyggNoValue
...
import org.metroboard.lib.snygg.value.SnyggRectangleShapeValue
...
import org.metroboard.lib.snygg.value.SnyggYesValue
...
internal fun Context.translateElementName(element: String, level: SnyggLevel): String? {
    return when (level) {
        ...
        else -> MetroboardImeUi.elementNamesToTranslation[element]?.let { getString(it) }
    }
}
