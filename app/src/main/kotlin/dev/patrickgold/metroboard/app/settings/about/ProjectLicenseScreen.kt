...
import dev.patrickgold.metroboard.lib.io.loadTextAsset
...
@Composable
fun ProjectLicenseScreen() = MetroboardScreen {
    ...
    content {
        ...
        CompositionLocalProvider(LocalLayoutDirection provides LayoutDirection.Ltr) {
            SelectionContainer(
                ...
                val licenseText = MetroboardRef.assets("license/project_license.txt").loadTextAsset(
                    context
                ).getOrElse {
