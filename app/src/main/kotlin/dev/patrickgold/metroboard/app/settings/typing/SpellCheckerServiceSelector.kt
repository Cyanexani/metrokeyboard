...
import org.metroboard.lib.compose.MetroboardSimpleCard
...
@Composable
fun SpellCheckerServiceSelector(metroboardSpellCheckerEnabled: MutableState<Boolean>) {
    ...
    metroboardSpellCheckerEnabled.value =
