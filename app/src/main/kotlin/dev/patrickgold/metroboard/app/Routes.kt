...
package dev.patrickgold.metroboard.app
...
import dev.patrickgold.metroboard.app.devtools.AndroidLocalesScreen
import dev.patrickgold.metroboard.app.devtools.AndroidSettingsScreen
import dev.patrickgold.metroboard.app.devtools.DevtoolsScreen
import dev.patrickgold.metroboard.app.devtools.ExportDebugLogScreen
import dev.patrickgold.metroboard.app.ext.CheckUpdatesScreen
import dev.patrickgold.metroboard.app.ext.ExtensionEditScreen
import dev.patrickgold.metroboard.app.ext.ExtensionExportScreen
import dev.patrickgold.metroboard.app.ext.ExtensionHomeScreen
import dev.patrickgold.metroboard.app.ext.ExtensionImportScreen
import dev.patrickgold.metroboard.app.ext.ExtensionImportScreenType
import dev.patrickgold.metroboard.app.ext.ExtensionListScreen
import dev.patrickgold.metroboard.app.ext.ExtensionListScreenType
import dev.patrickgold.metroboard.app.ext.ExtensionViewScreen
import dev.patrickgold.metroboard.app.settings.HomeScreen
import dev.patrickgold.metroboard.app.settings.about.AboutScreen
import dev.patrickgold.metroboard.app.settings.about.ProjectLicenseScreen
import dev.patrickgold.metroboard.app.settings.about.ThirdPartyLicensesScreen
import dev.patrickgold.metroboard.app.settings.advanced.BackupScreen
import dev.patrickgold.metroboard.app.settings.advanced.OtherScreen
import dev.patrickgold.metroboard.app.settings.advanced.PhysicalKeyboardScreen
import dev.patrickgold.metroboard.app.settings.advanced.RestoreScreen
import dev.patrickgold.metroboard.app.settings.clipboard.ClipboardScreen
import dev.patrickgold.metroboard.app.settings.dictionary.DictionaryScreen
import dev.patrickgold.metroboard.app.settings.dictionary.UserDictionaryScreen
import dev.patrickgold.metroboard.app.settings.dictionary.UserDictionaryType
import dev.patrickgold.metroboard.app.settings.gestures.GesturesScreen
import dev.patrickgold.metroboard.app.settings.keyboard.InputFeedbackScreen
import dev.patrickgold.metroboard.app.settings.keyboard.KeyboardScreen
import dev.patrickgold.metroboard.app.settings.localization.LanguagePackManagerScreen
import dev.patrickgold.metroboard.app.settings.localization.LanguagePackManagerScreenAction
import dev.patrickgold.metroboard.app.settings.localization.LocalizationScreen
import dev.patrickgold.metroboard.app.settings.localization.SelectLocaleScreen
import dev.patrickgold.metroboard.app.settings.localization.SubtypeEditorScreen
import dev.patrickgold.metroboard.app.settings.media.MediaScreen
import dev.patrickgold.metroboard.app.settings.smartbar.SmartbarScreen
import dev.patrickgold.metroboard.app.settings.theme.ThemeManagerScreen
import dev.patrickgold.metroboard.app.settings.theme.ThemeManagerScreenAction
import dev.patrickgold.metroboard.app.settings.theme.ThemeScreen
import dev.patrickgold.metroboard.app.settings.typing.TypingScreen
import dev.patrickgold.metroboard.app.setup.SetupScreen
import org.metroboard.lib.compose.MetroTurnstileContainer
...
private inline fun <reified T : Any> NavGraphBuilder.composableWithDeepLink(
    ...
    composable<T>(
        deepLinks = listOf(navDeepLink<T>(basePath = "ui://metroboard/${deeplink.path}")),
